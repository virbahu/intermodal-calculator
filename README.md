...
*Advanced intermodal optimization for enterprise supply chain operations*

---

## 📋 Overview

**Intermodal Calculator** addresses a critical challenge in modern supply chain management: intermodal. This implementation combines rigorous academic methodology with production-ready Python code, suitable for both research and enterprise deployment.
...
Supply chain intermodal is a persistent operational challenge that impacts cost, service, and working capital across the enterprise. Organizations that fail to optimize intermodal typically see:
...
```bash
git clone https://github.com/virbahu/intermodal-calculator.git
cd intermodal-calculator
pip install -r requirements.txt
python intermodal_calculator.py
```
...
```python
# Quick start example
from intermodal_calculator import *
...
# See docstrings in intermodal_calculator.py for full parameter reference
```
